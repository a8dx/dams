...
Figure \ref{bottom} shows discharge statistics for the lowest of these four gauges, in $m^3 s^{-1}$. % 890
...
\bibliographystyle{../papers/apsr2}
\bibliography{../papers/dams, ../papers/ald_ref}
